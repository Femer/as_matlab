% mpc_boatTack_h25 - a fast interior point code generated by FORCES
%
%   OUTPUT = mpc_boatTack_h25(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = mpc_boatTack_h25(PARAMS) returns additionally
%   the integer EXITFLAG indicating the state of the solution with 
%       1 - Optimal solution has been found (subject to desired accuracy)
%       0 - Maximum number of interior point iterations reached
%      -7 - Line search could not progress
%
%   [OUTPUT, EXITFLAG, INFO] = mpc_boatTack_h25(PARAMS) returns 
